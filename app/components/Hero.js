    ...
    <>
      <section className="py-32 bg-white">
        <div className="container mx-auto">
          <div className="lg:bg-[url('/images/hero.svg')] md:bg-[url('/images/hero-sm.svg')] bg-[url('/images/hero.svg')] bg-cover bg-center bg-no-repeat backdrop-blur-md border border-gray-200 shadow-lg rounded-2xl px-10 py-16 text-center">
